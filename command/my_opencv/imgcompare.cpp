...
//直方图比对
bool imgcompare::compareFacesByHist(Mat img,Mat orgImg)
{
    Mat tmpImg;
...
void imgcompare::compareImg(QString img1Path,QString img2Path)
{
    Mat orgImg = imread("/home/machine/work/test.jpg");
    Mat img = imread("/home/machine/work/test.jpg");
