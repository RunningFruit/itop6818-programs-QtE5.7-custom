...
void rtc::timerEvent(QTimerEvent *event)
{
    QDate d = QDate::currentDate();
    QTime t = QTime::currentTime();
...
void rtc::moveEvent(QMoveEvent *)
{
    this->move(QPoint(0,0));
}

void rtc::resizeEvent(QResizeEvent *)
{
    this->showMaximized();
}

void rtc::closeEvent(QCloseEvent *)
{
    destroy();
    exit(0);
}
